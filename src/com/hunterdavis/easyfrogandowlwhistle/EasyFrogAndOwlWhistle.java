package com.hunterdavis.easyfrogandowlwhistle;
...
public class EasyFrogAndOwlWhistle extends Activity { 
    ...
    public void onCreate(Bundle savedInstanceState) {
		...
		OnClickListener dogOneListener = new OnClickListener() {
			public void onClick(View v) {
				playFrequency(v.getContext(), 3000);
			}
		};
		...
		OnClickListener dogTwoListener = new OnClickListener() {
			public void onClick(View v) {
				playFrequency(v.getContext(), 3500);
			}
		};
		...
		OnClickListener dogThreeListener = new OnClickListener() {
			public void onClick(View v) {
				playFrequency(v.getContext(), 2000);
			}
		};
		...
		OnClickListener dogFourListener = new OnClickListener() {
			public void onClick(View v) {
				playFrequency(v.getContext(), 6000);
			}
		};
